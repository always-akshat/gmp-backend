 ...
 */
public class ParkingEventsKumbhEMailingJob implements Job {

    private static final Logger logger = LoggerFactory.getLogger(ParkingEventsKumbhEMailingJob.class);
    ...
    public ParkingEventsKumbhEMailingJob() {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        CompanyEntity company = companyDAO.findById(3142);

        for (ParkingEntity parking : company.getParkings()) {
            DateTime reportDate = DateTime.now().toDateTime(DateTimeZone.forOffsetHoursMinutes(5,30));
